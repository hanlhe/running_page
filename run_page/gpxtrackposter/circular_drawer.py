...
class CircularDrawer(TracksDrawer):
    ...
    def _draw_year(self, dr: svgwrite.Drawing, size: XY, offset: XY, year: int):
        ...
        year_style = f"dominant-baseline: central; font-size:{min_size * 4.0 / 80.0}px; font-family:'IBM Plex Sans';"
        month_style = (
            f"font-size:{min_size * 3.0 / 80.0}px; font-family:'IBM Plex Sans';"
        )

...
class GithubDrawer(TracksDrawer):
    ...
    def draw(self, dr: svgwrite.Drawing, size: XY, offset: XY):
        ...
        year_style = f"font-size:{year_size}px; font-family:'IBM Plex Sans';"
        year_length_style = (
            f"font-size:{110 * 3.0 / 80.0}px; font-family:'IBM Plex Sans';"
        )
        month_names_style = f"font-size:2.5px; font-family:'IBM Plex Sans'"
